...
public class PowerUp : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.GetComponent<Character_Movement>() != null && !isGrabed)
        {
            ...
            SoundManager.instance.PlaySound(SoundManager.SoundChannel.SFX, getSound, transform);
    ...
    public void ExitAnimation()
    {
        ...
        SoundManager.instance.PlaySound(SoundManager.SoundChannel.SFX, myGetSound, transform);
